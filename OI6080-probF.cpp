...
注：在满足条件下（上课时交头接耳的学生对数最少时），输出按编号从小到大输出。
...
MinimumObject row[100001];
MinimumObject col[100001];
//丢bss段，全部置0

int cmp(MinimumObject o1,MinimumObject o2) {
